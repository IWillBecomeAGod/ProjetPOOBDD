...
#pragma endregion
	...
	{
		this->ds->Clear();
		this->ds = this->processusPersonnes->listePersonnes("TB_PERSONNE");
		this->txt_idPersonne->Text = Convert::ToString(this->ds->Tables["TB_PERSONNE"]->Rows[this->index]->ItemArray[0]);
		this->txt_nom->Text = Convert::ToString(this->ds->Tables["TB_PERSONNE"]->Rows[this->index]->ItemArray[1]);
		this->txt_prenom->Text = Convert::ToString(this->ds->Tables["TB_PERSONNE"]->Rows[this->index]->ItemArray[2]);
	}
	...
	{
		if (this->index < this->ds->Tables["TB_PERSONNE"]->Rows->Count - 1)
		{
			this->index++;
			this->loadData(this->index);
			this->txt_message->Text = "Enregistrement n° : " + (this->index + 1);
	...
	{
		this->index = this->ds->Tables["TB_PERSONNE"]->Rows->Count - 1;
		this->loadData(this->index);
		this->txt_message->Text = "Enregistrement n° : " + (this->index + 1);
